        ...
        else if (condition == COND_OWNER)
        {
            ...
            else if (actualCommand.equalsIgnoreCase("functions"))
            {
                ...
                else if (val.equalsIgnoreCase("support"))
                {
                    ...
                    if (player.getPowerBuffer()) {
                   	 if (getClanHall().getFunction(ClanHall.FUNC_SUPPORT)== null){
                            html.replace("</body></html>","<CENTER><font color='#00FFFF'>Power Buffer </font><br>");
                            html.appendFile(player.getHtmlPrefix(),"data/html/clanHallManager/powerbuffer.htm");
                            html.append("</CENTER></body></html>");
                    	}
                   	 	else{
                   	 		int value = getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() * 10;
                   	 	    html.replace("</body></html>","<CENTER><font color='#00FFFF'>Power Buffer </font><br>");
                   	 	    html.appendFile(player.getHtmlPrefix(),"data/html/clanHallManager/powerbuffer-all.htm");
                   	 	    html.replace("%value",String.valueOf(value));
                   	 	    html.append("</CENTER></body></html>");
                        }
                   }
                    sendHtmlMessage(player, html);
            ...
            else if (actualCommand.equalsIgnoreCase("list_back"))
            {
                ...
                if ( player.getPowerBuffer() ) {
                	html.replace("</body></html>","<CENTER><a action=\"bypass -h npc_%objectId%_Quest 1111_NPCBuffer\">Power Buffer</a><br></CENTER></body></html>");
                }
              	sendHtmlMessage(player, html);
            	return;
            }
            ...
            { 
            	NpcHtmlMessage html = new NpcHtmlMessage(1); 
            	if ( getClanHall().getFunction(ClanHall.FUNC_SUPPORT)== null && !player.getPowerBuffer())
            		return;
            	else if ( getClanHall().getFunction(ClanHall.FUNC_SUPPORT)== null && player.getPowerBuffer() ) {
            	   html.setHtml("<html><body><CENTER><font color='#00FFFF'>Power Buffer </font><br>");
                   html.appendFile(player.getHtmlPrefix(),"data/html/clanHallManager/powerbuffer.htm");
                   html.append("</CENTER></body></html>");
                   sendHtmlMessage(player,html);
                   return;
            	}
            	else if (player.getPowerBuffer() && getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() == 0) {
                  	       html.setHtml("<html><body><CENTER><font color='#00FFFF'>Power Buffer </font><br>");
                           html.appendFile(player.getHtmlPrefix(),"data/html/clanHallManager/powerbuffer.htm");
                           html.append("</CENTER></body></html>");
                           sendHtmlMessage(player,html);
